...
public interface GetDtoByCriteria<D extends DtoPersistente,E extends EntidadPersistente,P extends FilterDto, CustomDto,ID>{
    ...
    default ResponsePaginator<?> findDtoByCriteria(@Valid P pageable){
        return getService().findDtoByCriteria(pageable);
    }
